...
| `building-lego-using-deep-generative-models-of-graphs` | Thompson, Ghalebi, DeVries, Taylor (Guelph/Vector) | Background. **No generative model is implemented.** |
